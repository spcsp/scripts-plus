function processMessage(val) {
    ...
    const debug = (obj) => sp.ShowBalloonTip(Object.keys(obj)[0], `${JSON.stringify(Object.values(obj)[0],null,2)}`, "Info", 5000);
...
var html = template(String.raw`C:\Users\Public\shop\automation\demos\html\index.html`, {
