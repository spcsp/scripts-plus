(() => {
  class ScriptyTypes {
    constructor() {
      this.outDir = String.raw`${__dirname}/@types/strokesplus.net/index.d.ts`;
    }

    run() {
      return File.WriteAllText(this.outDir, this._buildMethods());
    }
    ...
    declare namespace ManagedWinapi.Windows {
      ...
      for (var m = 0; m < spms.Count(); m++) {
        ...
        const returnType = this._mapReturnType(spms[m].ReturnType.Name);
