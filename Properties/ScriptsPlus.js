...
var _clr$System$IO = clr.System.IO,
    Directory = _clr$System$IO.Directory,
    File = _clr$System$IO.File,
    Path = _clr$System$IO.Path;
var _clr$System$Environme = clr.System.Environment,
    GetFolderPath = _clr$System$Environme.GetFolderPath,
    SpecialFolder = _clr$System$Environme.SpecialFolder;

var expand = function expand(v) {
  return sp.ExpandEnvironmentVariables("%".concat(v, "%"));
};

var specialFolder = function specialFolder(n) {
  return GetFolderPath(SpecialFolder[n]);
};
...
module.exports = _objectSpread(_objectSpread({}, env), {}, {
  expand: expand,
...
var _clr$System$IO$Direct = clr.System.IO.Directory,
    CreateDirectory = _clr$System$IO$Direct.CreateDirectory,
    GetFiles = _clr$System$IO$Direct.GetFiles;
...
module.exports = {
  ...
  notepadPlusPlus: __webpack_require__(/*! ./notepadPlusPlus */ "./src/notepadPlusPlus.js"),
  objKeysToStr: __webpack_require__(/*! ./objKeysToStr */ "./src/objKeysToStr.js"),
  ...
  window: __webpack_require__(/*! ./window.js */ "./src/window.js")
};
...
function objKeysToStr(obj) {
  ...
  return keys.map(function (k) {
    return "key: ".concat(k, ", typeof: ").concat(_typeof(obj[k]));
  }).join("\n");
}
